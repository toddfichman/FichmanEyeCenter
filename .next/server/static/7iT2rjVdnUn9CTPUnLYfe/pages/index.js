...
var external_google_maps_react_ = __webpack_require__(13);
...
var Slogan = __webpack_require__(7);
...
var review = external_react_default.a.createElement("div", {
  style: {
    marginTop: ".5rem"
  }
...
/* harmony default export */ var Testimonials = (function () {
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", {
    className: "map-header"
  }, "Testimonials"), external_react_default.a.createElement(external_react_bootstrap_["Col"], {
    xs: 12,
    md: 4
...
var pages_Home = function Home() {
  ...
  }, "Schedule An Appointment Today")))))), external_react_default.a.createElement(external_react_bootstrap_["Grid"], {
  ...
  }, "Connecticut's Leading Eye Care Professionals"), external_react_default.a.createElement("p", {
    className: "text-section-paragraph"
  }, "When it comes to eye care, Fichman Eye Center has a wide variety of CERTIFIED OPTICIANS who are specialized in enhancing your eyesight for strength and clarity. With four locations around Connecticut, we can help residents from all corners of the state with their visual needs and answer any questions they might have."), external_react_default.a.createElement("p", {
    className: "text-section-paragraph"
  }, "We strive to provide the best quality vision with our optical boutiques at each facility that help you find the perfect eyewear or contact lenses to suit your lifestyle. With a variety of brands available, you can enhance your eyesight in style."), external_react_default.a.createElement("p", {
    className: "text-section-paragraph"
  }, "If you want to ditch the glasses and contact lenses altogether, we offer innovative LASER CATARACT SURGERY, which provides an accurate and successful procedure for vision excellence. This technology utilizes an advanced laser to deliver a precise incision for safety and care. You will be able to enjoy your enhanced eyesight without ever having to rely on visual assistance again."), external_react_default.a.createElement("p", {
    className: "text-section-paragraph"
  }, "Whatever your visual needs, our friendly and professional staff are here to help you see. Contact one of our specialists today, to see how Fichman Eye Center can benefit you."))), external_react_default.a.createElement(external_react_bootstrap_["Row"], {
  ...
  }, external_react_default.a.createElement(Testimonials, null)), external_react_default.a.createElement("div", {
  ...
  }, "Read More Testimonials"))), external_react_default.a.createElement(external_react_bootstrap_["Row"], {
